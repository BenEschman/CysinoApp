...
import com.example.cycino.View.MainSettingsActivity;
...
public class SystemTest1 {
    ...
    @Rule
    public ActivityScenarioRule<MainSettingsActivity> activityScenarioRule = new ActivityScenarioRule<>(MainActivity.class);
